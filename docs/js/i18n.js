(() => {
  const de = {
    ...
    "desktop.title":"Lieber offline?","desktop.text":"Die Windows-Version enthält eine lokale QR-Engine und kann QR-Codes erzeugen, ohne den Inhalt an einen externen Erzeugungsdienst zu übertragen.","desktop.download":"Desktop-Version herunterladen →",
  ...
  const en = {
    ...
    "desktop.title":"Prefer offline?","desktop.text":"The Windows version includes a local QR engine and can generate QR codes without sending their contents to an external generation service.","desktop.download":"Download desktop version →",
