...
function Add-LogoToQr {
    ...
    try {
        ...
        try {
            ...
            $temp = Join-Path ([System.IO.Path]::GetTempPath()) ("qr_logo_" + [guid]::NewGuid().ToString("N") + ".png")
    ...
    if ($fileInfo.Length -gt 950KB) {
        ...
        try {
            ...
            try {
                ...
                $testPath = Join-Path ([System.IO.Path]::GetTempPath()) ("qr_test_" + [guid]::NewGuid().ToString("N") + ".png")
